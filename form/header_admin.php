   ...
   <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Perpustakaan Universitas Diponegoro</a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="dashboard.php"><span class="glyphicon glyphicon-home"></span>&nbsp;Beranda</a></li>
			<li class="parent">
				<a href="#">
			...
			<li class="parent">
				...
				<ul class="children collapse" id="sub-item-4">
					<li>
                        <a href="data_staff.php">Data Staff</a>
                    </li>
                    <li>
                        <a href="input_staff.php">Input Data Staff</a>
                    </li>
                    <li>
